...
<body>
    ...
    <div class="display-ad-header darker">
        ...
        <ul class="display-ad-header-menu">
            <li class="display-ad-header-menu-item"><a href="/display-ad">광고 안내</a>
            <div class="menuline"></div></li>
            <li class="display-ad-header-menu-bar">|</li>
            <li class="display-ad-header-menu-item active"><a href="/display-ad/contact">광고 문의</a>
    ...
    <div class="display-ad-contact-container">
        ...
        <div class="contact-box">
            <ul class="contact-form">
                <li class="contact-form-line">
                    ...
                    <select name="contact-sort" class="contact-form-select">
                ...
                <li class="contact-form-line">
                    ...
                    <input type="text" class="contact-form-writespace"/>
                </li>
                <li class="contact-form-line">
                ...
                <li class="contact-form-line">
                    ...
                    <input type="text" placeholder="Ex) 1개월, 25일, 7일 or 12/27~12/31, 1/1~1/31 등" class="contact-form-writespace"/>
                </li>
                <li class="contact-form-line">
                    <div class="contact-form-sort">희망예산<span class="red">*</span></div>
                    <input type="text" placeholder="Ex) 300만 원, 500만 원" class="contact-form-writespace"/>
                </li>
                <li class="contact-form-line">
                    <div class="contact-form-sort">내용<span class="red">*</span></div>
                    <textarea placeholder="Ex) 야구 게임 광고, 공무원 학원 광고 등" class="contact-form-textarea"></textarea>
                </li>
                <li class="contact-form-line">
        ...
        <div class="contact-checkbox-container">
            ...
            <div class="contact-checkbox-confirm">
                <input type="checkbox"/>내용을 확인하였으며, 동의합니다.
            </div>
