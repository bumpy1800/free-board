...
<html lang="kr">
	...
	<body>
        ...
        @yield('header')
		<div class="container">
            <div class="gallery-create-title">마이너 갤러리 만들기 <span>(만들는 6개까지 가능합니다.)</span></div>
                    ...
                    <div class="gallery-create-form">
                        <div class="gallery-create-form-contents">
                            <div class="gallery-create-form-space">
                                ...
                                <div class="gallery-create-form-write">
                                    <div class="gallery-create-form-name">
                                        <input type="text" placeholder="마이너 갤러리의 이름을 간단히 넣어주세요."/>
                                        <span>마이너 갤러리</span>
                                    </div>
                            ...
                            <div  class="gallery-create-form-space">
                                ...
                                <div class="gallery-create-form-write">
                                    <textarea placeholder="마이너 갤러리에 대한 설명을 넣어주세요."></textarea>
                                </div>
                            </div>
                            <div  class="gallery-create-form-space">
                            ...
                            <div  class="gallery-create-form-space">
                                ...
                                <div class="gallery-create-form-write">
                                    <input placeholder="운영자에게 전달되는 메세지입니다." type="text" class="gallery-crate-form-reason" /> 
