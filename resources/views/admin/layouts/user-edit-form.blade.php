            ...
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                              <form name="form" action="{{ route('user.update', $User->id) }}" method="post">
                                @METHOD('PATCH')
                                @csrf
                                <div class="form-group">
                                  <label for="uid">회원 아이디</label>
                                  <input type="text" name="uid" class="form-control" id="uid" value="{{ $User->uid }}">
                                  @error('uid')
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="password" name="pwd" class="form-control" id="pwd" value="{{ $User->pwd }}">
                                  @error('pwd')
                                      <small style="color: red!important;" id="danger" class="form-text text-muted">{{ $message }}</small>
                                  @enderror
                                </div>
