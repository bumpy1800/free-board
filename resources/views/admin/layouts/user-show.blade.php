                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                                <div class="form-group">
                                  ...
                                  <input type="text" name="uid" class="form-control" id="uid" value="{{ $User->uid }}" disabled>
                                </div>
                                <div class="form-group">
                                  <label for="nick">회원 닉네임</label>
                                  <input type="text" name="nick" class="form-control" id="nick" value="{{ $User->nick }}" disabled>
                                </div>
                                <div class="form-group">
                                  <label for="pwd">카테고리</label>
                                  <input type="password" name="pwd" class="form-control" id="pwd" value="{{ $User->pwd }}" disabled>
                                </div>
                                <div class="form-group">
                                ...
                                <form class="" action="{{ route('user.destroy', $User->id) }}" method="post">
                                    @METHOD('DELETE')
                                    @csrf
                                    <a class="btn btn-warning" href="{{ route('user.edit', $User->id) }}">수정</a>
