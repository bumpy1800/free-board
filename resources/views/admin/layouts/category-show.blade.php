        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header"><i class="fas fa-eye"></i></i>{{ $category->name }} 카테고리</div>
                        <div class="card-body">
                          <form name="form">
                            @csrf
                            <div class="form-group">
                              <label for="name">카테고리 이름</label>
                              <input type="text" name="name" class="form-control" id="name" value="{{ $category->name }}" disabled>
                            </div>
                            <a class="btn btn-warning" href="{{ route('admin_category.edit', $category->id) }}">수정</a>
