                        ...
                        <div class="card-header"><i class="fas fa-table mr-1"></i>팝업 목록
                          <div class="menu_list">
                            <div style="margin-left: 10px; float: left;">
                              <a id="menu_list"class="btn btn-warning" href="{{ route('admin_popup2.create') }}">등록</a>
                            </div>
                          </div>
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        @foreach ($popups as $popup)
                                          <tr>
                                            <td>{{ $popup->id }}</td>
                                            <td><a href="{{ route('admin_popup2.show', $popup->id) }}">{{ $popup->name }}</a></td>
                                            ...
                                            @else
                                              <td>광고중</td>
                                            @endif
                                            <td><a id="edit" class="btn btn-warning" href="{{ route('admin_popup2.edit', $popup->id) }}">수정</a></td>
                                            <td>
