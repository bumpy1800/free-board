        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header"><i class="far fa-edit"></i>QnA종류 수정</div>
                        <div class="card-body">
                          <form name="form" action="{{ route('admin_qna_category.update', $qna_category->id) }}" method="post">
                            @method('PATCH')
                            @csrf
                            <div class="form-group">
                              <label for="name">QnA종류 이름</label>
                              <input type="text" name="id" class="form-control" id="name" value="{{ $qna_category->id }}">
                              @error('name')
