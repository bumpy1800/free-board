        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header"><i class="fas fa-table mr-1"></i>갤러리 목록
                          <a style="float: right; padding-top: 0px; padding-bottom: 0px;" class="btn btn-warning" href="/admin/gallery-add-form">등록테스트</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($gallerys as $gallery)
                                          <tr>
                                            ...
                                            <td>{{ $gallery->heads }}</td>
                                            <td>{{ $gallery->agree }}</td>
                                            <td><a id="edit" class="btn btn-warning" href="/admin/gallery-edit-form/{{ $gallery->id }}">수정</a></td>
                                            <td><a id="del" class="btn btn-danger" href="/admin/gallery-destroy/{{ $gallery->id }}">삭제</a></td>
                                          </tr>
                                        @endforeach
                                    </tbody>
                                </table>
