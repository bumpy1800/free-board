        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header"><i class="fas fa-table mr-1"></i>QnA 목록
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        @foreach ($qnas as $qna)
                                          <tr>
                                            <td>{{ $qna->id }}</td>
                                            <td><a href="{{ route('admin_qna_category.show', $qna->category) }}">{{ $qna->category }}</a></td>
                                            <td><a href="{{ route('admin_qna.show', $qna->id) }}">{{ $qna->title }}</a></td>
                                            <td><a id="edit" class="btn btn-warning" href="{{ route('admin_qna.edit', $qna->id) }}">수정</a></td>
                                            <td>
