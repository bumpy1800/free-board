        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header"><i class="fas fa-eye"></i></i>{{ $qna_category->id }} QnA종류</div>
                        <div class="card-body">
                          <form name="form">
                            @csrf
                            <div class="form-group">
                              <label for="name">QnA종류 이름</label>
                              <input type="text" name="id" class="form-control" id="name" value="{{ $qna_category->id }}" disabled>
                            </div>
                            <a class="btn btn-warning" href="{{ route('admin_qna_category.edit', $qna_category->id) }}">수정</a>
