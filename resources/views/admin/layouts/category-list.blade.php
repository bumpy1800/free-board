        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header"><i class="fas fa-table mr-1"></i>카테고리 목록
                          <a style="float: right; padding-top: 0px; padding-bottom: 0px;" class="btn btn-warning" href="{{ route('admin_category.create') }}">등록테스트</a>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        @foreach ($categorys as $category)
                                          <tr>
                                            <td>{{ $category->id }}</td>
                                            <td><a href="{{ route('admin_category.show', $category->id) }}">{{ $category->name }}</a></td>
                                            <td><a id="edit" class="btn btn-warning" href="{{ route('admin_category.edit', $category->id) }}">수정</a></td>
                                            <td>
