        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header"><i class="fas fa-table mr-1"></i>회원 목록
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        @foreach ($Users as $user)
                                          <tr>
                                            <td>{{ $user->id }}</td>
                                            <td><a href="{{ route('user.show', $user->id) }}">{{ $user->uid }}</a></td>
                                            <td>{{ $user->nick }}</td>
                                            <td>{{ $user->name }}</td>
                                            <td>{{ $user->email }}</td>
                                            <td>{{ $user->chk_email }}</td>
                                            <td>{{ $user->reg_date }}</td>
                                            <td>{{ $user->status }}</td>
                                            <td>{{ $user->gallery_id }}</td>
                                            <td><a id="edit" class="btn btn-warning" href="{{ route('user.edit', $user->id) }}">수정</a></td>
