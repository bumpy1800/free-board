                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                              <form name="form" action="" method="">
                                 @csrf
                                <input type="text" name="s_name" value="{{ $gallery->s_name }}" disabled>
                                <input type="text" name="name" value="{{ $gallery->name }}" disabled>
                                <input type="text" name="category_id" value="{{ $gallery->category_id }}" disabled>
                                <input type="text" name="link" value="{{ $gallery->link }}" disabled>
                                <input type="text" name="contents" value="{{ $gallery->contents }}" disabled>
                                <input type="text" name="reason" value="{{ $gallery->reason }}" disabled>
                                <input type="text" name="heads" value="{{ $gallery->heads }}" disabled>
                                <input type="text" name="agree" value="{{ $gallery->agree }}" disabled>
                              </form>
                        </div>
                    </div>
                </div>
