...
<body class="sb-nav-fixed">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-xl-6 col-md-6">
                            <div class="card bg-primary text-white mb-4">
                                <div class="card-body">{{ $totalSingo }}</div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <div class="small text-white">전체 신고 수</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xl-6 col-md-6">
                            <div class="card bg-warning text-white mb-4">
                                <div class="card-body">{{ $todaySingo }}</div>
                                <div class="card-footer d-flex align-items-center justify-content-between">
                                    <div class="small text-white">오늘 신고 수</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="card mb-4">
                        <div class="card-header">
                            ...
                            <span class="tab_menu_post">최근 한 달간 신고 수 <span id="category">(전체)</span></span>
                            <div style="float: right;">
                                <select style="height: 30px;" class="singo_category">
                                  <option value="0">전체</option>
                                  @foreach ($singo_categorys as $singo_category)
                                    <option value="{{ $singo_category->id }}">{{ $singo_category->name }}</option>
                                  @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="col-xl-6">
                            <div class="card mb-4">
                                <div class="card-header"><i class="fas fa-chart-area mr-1"></i>최근 신고 수</div>
                                <div class="card-body"><canvas id="DayAreaChart" width="100%" height="40"></canvas></div>
                            </div>
                        </div>
                        <div class="col-xl-6">
                            <div class="card mb-4">
                                <div class="card-header"><i class="fas fa-chart-bar mr-1"></i>한 달 신고 수</div>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                          <i class="fas fa-chart-pie mr-1"></i>종류별 신고 수
    ...
    <script src="{{ asset('assets/admin/dist/assets/demo/singo-stat-chart.js') }}"></script>
