            ...
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                              <form name="form" action="{{ route('admin_popup_category.store') }}" method="post">
                                @method('POST')
                                @csrf
                                <div class="form-group">
                                  <label for="name">팝업 종류 이름</label>
                                  <input type="text" name="id" class="form-control" id="name" value="">
                                  @error('name')
