        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header"><i class="fas fa-eye"></i></i>{{ $popup_category->id }} 팝업</div>
                        <div class="card-body">
                          <form name="form">
                            @csrf
                            <div class="form-group">
                              <label for="name">팝업 이름</label>
                              <input type="text" name="id" class="form-control" id="name" value="{{ $popup_category->id }}" disabled>
                            </div>
                            <a class="btn btn-warning" href="{{ route('admin_popup_category.edit', $popup_category->id) }}">수정</a>
