        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header"><i class="fas fa-eye"></i></i>{{ $Logo->name }}</div>
                        <div class="card-body">
                          <form name="form">
                            @csrf
                            <div class="form-group">
                              <label for="name">로고명</label>
                              <input type="text" name="name" class="form-control" id="name" value="{{ $Logo->name }}" disabled>
                            </div>
                            <div class="form-group">
                              <label for="pic">로고</label>
                              <img src="data:image/png;base64,{{ $pic }}" alt="title" />
                            </div>
                            <a class="btn btn-warning" href="{{ route('admin_logo.edit', $Logo->id) }}">수정</a>
