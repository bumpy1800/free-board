        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    ...
                    <div class="card mb-4">
                        <div class="card-header"><i class="far fa-edit"></i>신고 카테고리 수정</div>
                        <div class="card-body">
                          <form name="form" action="{{ route('admin_singo_category.update', $singo_category->id) }}" method="post">
                            @method('PATCH')
                            @csrf
                            <div class="form-group">
                              <label for="name">카테고리명</label>
                              <input type="text" name="name" class="form-control" id="name" value="{{ $singo_category->name }}">
                              @error('name')
