@if ($paginator->hasPages())
    <nav style="display: inline-block;">
        <ul class="pagination" style="margin-bottom: 0px;">
            ...
            @else
                <li class=".prev"><a id="prev" href="{{ $paginator->previousPageUrl() }}" rel="prev"><i class="fa fa-arrow-left" aria-hidden="true"></i></a></li>
            @endif
            ...
            @if ($paginator->hasMorePages())
                <li class=".next"><a id="next" href="{{ $paginator->nextPageUrl() }}" rel="next"><i class="fa fa-arrow-right" aria-hidden="true"></i></a></li>
            @else
